...
REM call cl -c /O2 %location%\tree_sitter\src\lib.c %location%\lang\cpp\parser.c %location%\lang\cpp\scanner.cc -I %location%\
REM call cl -c /Zi %location%\tree_sitter\src\lib.c ^
call cl -c /O2 /Zi %location%\tree_sitter\src\lib.c ^
     %location%\lang\cpp_parser.c %location%\lang\cpp_scanner.cc^
     -I %location%\

call cl %opts% "%target%" %location%\lib.obj ^
     %location%\cpp_parser.obj %location%\cpp_scanner.obj ^
     /Fe%binname% %build_dll%
