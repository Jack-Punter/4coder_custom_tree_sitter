...
ts_data = managed_id_declare(app, string_u8_litexpr("attachment"), string_u8_litexpr("ts_data"));
ts_async_parse_task = managed_id_declare(app, string_u8_litexpr("attachment"), string_u8_litexpr("ts_async_parse_task"));
